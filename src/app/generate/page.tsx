        ...
        <section className="mt-6 grid gap-4">
            ...
            {poseOn && (
              <div className="mt-2 space-y-2">
                <input
                  ...
                  placeholder="Décrire la pose"
                  className="w-full rounded-md border border-gray-300 px-2 py-1 text-sm"
                />
                <div className="flex flex-wrap gap-2 text-xs">
                  {["Frontal", "3/4", "Profil", "Mains dans les poches"].map(
                    (p) => (
                      <button
                        key={p}
                        onClick={() => setPose(p)}
            ...
            {styleOn && (
              <div className="mt-2 space-y-2">
                <input
                  ...
                  placeholder="Style de l'image"
                  className="w-full rounded-md border border-gray-300 px-2 py-1 text-sm"
                />
                <div className="flex flex-wrap gap-2 text-xs">
                  {["Studio neutre", "Éditorial", "E-commerce propre"].map(
                    (p) => (
                      <button
                        key={p}
                        onClick={() => setStyle(p)}
          ...
          <div>
            <label className="flex items-center gap-2 text-sm font-medium text-gray-400">
              ...
              Description <span className="text-xs">(arrive bientôt)</span>
            </label>
          </div>
